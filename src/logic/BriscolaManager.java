...
public class BriscolaManager {
	...
	public boolean gioca(Carta c) {
		...
		return false;
		/*
		 * if (controllaGiocata()) { //System.out.println("seh giustoh"); return
			...
			if (cartaG1.getSeme() == briscola.getSeme()) {
				if (cartaG2.getSeme() != briscola.getSeme()) {
					...
					if (cartaG1.getValore() > cartaG2.getValore()) {
						...
						turno = 0;
						giocoMano = 0;
					} else if (cartaG1.getValore() == 0
							&& cartaG2.getValore() == 0
							&& cartaG1.getId() > cartaG2.getId()) {
						System.out
								.println("prende g1 con briscola piu alta parte 2");
						g1.aggiungiCartaPresa(cartaG1);
						g1.aggiungiCartaPresa(cartaG2);
						turno = 0;
						giocoMano = 0;
				...
				if (cartaG2.getSeme() == briscola.getSeme()) {
					...
					if (cartaG1.getSeme() != cartaG2.getSeme()) {
						System.out
								.println("prende g1 con il turno a favore e carte diverse");
						// prende g1
						g1.aggiungiCartaPresa(cartaG1);
						g1.aggiungiCartaPresa(cartaG2);
						turno = 0;
						...
						System.out
								.println("carte sul banco stesso seme non briscola");
						if (cartaG1.getValore() > cartaG2.getValore()) {
							// prende g1
							...
							// prende g1
							System.out
									.println("prende G1 con carta migliore parte 2");
							g1.aggiungiCartaPresa(cartaG1);
							g1.aggiungiCartaPresa(cartaG2);
							turno = 0;
							giocoMano = 0;
					...
					if (cartaG1.getSeme() != cartaG2.getSeme()) {
						System.out
								.println("prende g2 con il turno a favore e carte diverse");
						// prende g1
						g2.aggiungiCartaPresa(cartaG1);
						g2.aggiungiCartaPresa(cartaG2);
						turno = 1;
						...
						turno = 1;
						giocoMano = 1;
					} else if (cartaG2.getValore() == 0
							&& cartaG1.getValore() == 0
							&& cartaG2.getId() > cartaG1.getId()) {
						// prende g2
						System.out
								.println(" prende G2 con valore Migliore di liscio");
						g2.aggiungiCartaPresa(cartaG1);
						g2.aggiungiCartaPresa(cartaG2);
						turno = 1;
						giocoMano = 1;
						...
						// prende g1
						System.out
								.println("prende G1 con carta migliore credo");
						g1.aggiungiCartaPresa(cartaG1);
						g1.aggiungiCartaPresa(cartaG2);
						turno = 0;
						giocoMano = 0;
